...
Beyond the core library features, the app includes a suite of AI-powered tools: semantic game similarity powered by a hybrid embedding pipeline, mood-based game discovery, and natural language overviews generated by GPT-4o-mini.
